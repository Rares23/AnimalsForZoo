...
class AnimalsControllerTest < ActionController::TestCase
  ...
  test "should create animal" do
    assert_difference('Animal.count') do
      post :create, animal: { description: @animal.description, name: @animal.name, species: @animal.species }
    end
  ...
  test "should update animal" do
    put :update, id: @animal, animal: { description: @animal.description, name: @animal.name, species: @animal.species }
    assert_redirected_to animal_path(assigns(:animal))
  end
